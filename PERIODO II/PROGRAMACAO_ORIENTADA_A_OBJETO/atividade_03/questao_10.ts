...
type DadosEstatisticos={
    media:number,
    maiorNumero:number,
    menorNumero:number
}

type EstatisticaDosSensoresIoT={
    sensorDeTemperatura:DadosEstatisticos,
    sensorDeUmidade:DadosEstatisticos,
    sensorDePoluicao:DadosEstatisticos,
    sensorDeRuidos:DadosEstatisticos
}

type SensoresIoT={
    tipoDoSensor:string,
    infoDoSensor:string,
    valorDaLeitura:number,
    carimboHorario:string
}


type TempoDeCalibracaoDosSensoresIoT={
    tipoDoSensor:string,
    tempoDeCalibracao:string
}



let dados_brutos_dos_sensores_iot:SensoresIoT[]=[
    {
...
let tempo_de_calibracao:TempoDeCalibracaoDosSensoresIoT[]=[]
...
let ed:EstatisticaDosSensoresIoT={
    sensorDeTemperatura:{
