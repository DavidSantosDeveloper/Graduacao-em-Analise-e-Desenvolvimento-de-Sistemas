...
exports.reduzir_uma_lista = void 0;
function mapear_uma_lista(lista, funcao_de_mapeamento, funcao_de_criterio) {
    let lista_mapeada = [];
...
exports.reduzir_uma_lista = reduzir_uma_lista;
...
let soma_da_lista_mapeada = lista_mapeada.reduce((valor_em_memoria, valor_atual) => {
