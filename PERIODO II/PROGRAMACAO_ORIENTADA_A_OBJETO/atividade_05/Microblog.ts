...
class Microblog{
    ...
    listaDePostagens:Array<Postagem>=[]

    private verificar_se_ja_existe_uma_postagem_com_um_id_especifico(id_postagem:number):boolean{
    ...
    consultarIndiceDeUmaPostagemPeloId(id_postagem:number){
    ...
    adicionarPostagem(nova_postagem:Postagem): void{
    ...
    removerPostagem(id_postagem:number){
    ...
    retornarPostagemMaisCurtida(){
        ...
        let postagem_com_mais_likes=this.listaDePostagens.reduce( 
            (postagemAnterior: Postagem, postagemAtual: Postagem, currentIndex: number, array: Postagem[]) => {
    ...
    curtirUmaPostagemPeloId(id_postagem:number){
        let indice_da_postagem=this.consultarIndiceDeUmaPostagemPeloId(id_postagem)
